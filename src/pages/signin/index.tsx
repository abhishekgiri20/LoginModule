...
//   };
//   const handleSignInRequest = async (e: any) => {
//     e.preventDefault();
//     if (!signinData.email) {
//       return toast.error("Please enter email first");
//     } else if (!signinData.password) {
//       return toast.error("Please enter password first");
//     }
...
//   const passwordRegex = /^[A-Za-z\d@$!%*?&]{8,}$/; // Password regex with minimum 8 characters, allowing letters, digits, and some special characters
...
//       return toast.error("Password must be at least 8 characters long and may include letters, digits, and some special characters");
//     }
